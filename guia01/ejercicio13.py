...
plot.plot(time_collection, signal_t.generate_function(time_collection))
plot.plot(time_collection, signal_t_plus_pi.generate_function(time_collection))
plot.plot(time_collection, signal_t_minus_pi.generate_function(time_collection))
plot.plot(time_collection, signal_minus_t_plus_pi.generate_function(time_collection))
plot.plot(time_collection, signal_times_4.generate_function(time_collection))
plot.plot(time_collection, signal_quarter.generate_function(time_collection))
plot.plot(time_collection, signal_half_reflected.generate_function(time_collection))
